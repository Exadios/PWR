...
#define LTE_SIMD_F_SIZE    16
#define LTE_SIMD_CF_SIZE   16

#define LTE_SIMD_I_SIZE    16

#define LTE_SIMD_B_SIZE    64
#define LTE_SIMD_S_SIZE    32
#define LTE_SIMD_C16_SIZE  0

#else
#ifdef LV_HAVE_AVX2

#define LTE_SIMD_F_SIZE    8
#define LTE_SIMD_CF_SIZE   8

#define LTE_SIMD_I_SIZE    8

#define LTE_SIMD_B_SIZE    32
#define LTE_SIMD_S_SIZE    16
#define LTE_SIMD_C16_SIZE  16

#else /* LV_HAVE_AVX2 */
#ifdef LV_HAVE_SSE

#define LTE_SIMD_F_SIZE    4
#define LTE_SIMD_CF_SIZE   4

#define LTE_SIMD_I_SIZE    4

#define LTE_SIMD_B_SIZE    16
#define LTE_SIMD_S_SIZE    8
#define LTE_SIMD_C16_SIZE  8
...
#else /* HAVE_NEON */
#define LTE_SIMD_F_SIZE    0
#define LTE_SIMD_CF_SIZE   0

#define LTE_SIMD_I_SIZE    0
#define LTE_SIMD_B_SIZE    0
#define LTE_SIMD_S_SIZE    0
#define LTE_SIMD_C16_SIZE  0
...
static inline SimdF_t LteSimdFLoad(const float *ptr)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFLoadu(const float *ptr)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline void LteSimdFStore(float *ptr, SimdF_t simdreg)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline void LteSimdFStoreu(float *ptr, SimdF_t simdreg)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFSet1(float x)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFMul(SimdF_t a, SimdF_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFRcp(SimdF_t a)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFAddsub(SimdF_t a, SimdF_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFSub(SimdF_t a, SimdF_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFAdd(SimdF_t a, SimdF_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFZero (void)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFSwap(SimdF_t a)
  {
#ifdef LV_HAVE_AVX512
...
#else /* LV_HAVE_SSE */
#ifdef HAVE_NEON
  return vcombine_f32(vrev64_f32(vget_low_f32(a)),
                                 vrev64_f32(vget_high_f32(a)));
#endif /* HAVE_NEON */
#endif /* LV_HAVE_SSE */
#endif /* LV_HAVE_AVX2 */
#endif /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFHadd(SimdF_t a, SimdF_t b)
  {
#ifdef LV_HAVE_AVX512
  ...
  SimdF_t a1 = _mm512_permutex2var_ps(a, idx1, b);
  SimdF_t b1 = _mm512_permutex2var_ps(a, idx2, b);
  return _mm512_add_ps(a1, b1);
#else /* LV_HAVE_AVX512 */
#ifdef LV_HAVE_AVX2
  SimdF_t a1 = _mm256_permute2f128_ps(a, b, 0b00100000);
  SimdF_t b1 = _mm256_permute2f128_ps(a, b, 0b00110001);
...
#else /* LV_HAVE_SSE */
#ifdef HAVE_NEON
  return vcombine_f32( vpadd_f32(vget_low_f32(a),
                                 vget_high_f32(a) ),
                                 vpadd_f32( vget_low_f32(b),
                                           vget_high_f32(b)));
#endif /* HAVE_NEON */
#endif /* LV_HAVE_SSE */
#endif /* LV_HAVE_AVX2 */
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFSqrt(SimdF_t a)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFNeg(SimdF_t a)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFNegMask(SimdF_t a, SimdF_t mask)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdFAbs(SimdF_t a)
  {
#ifdef LV_HAVE_AVX512
...
#ifdef HAVE_NEON
typedef float32x4x2_t SimdCf_t;
#else
typedef struct
  {
  SimdF_t re;
...
static inline SimdCf_t LteSimdCfiLoad(const Cf_t *ptr)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
  __m512 in1 = _mm512_load_ps((float*)(ptr));
  __m512 in2 = _mm512_load_ps((float*)(ptr + LTE_SIMD_CF_SIZE / 2));
  ret.re = _mm512_permutex2var_ps(in1,
                                  _mm512_setr_epi32(0x00, 0x02, 0x04, 0x06,
                                                    0x08, 0x0A, 0x0C, 0x0E,
                                                    0x10, 0x12, 0x14, 0x16,
                                                    0x18, 0x1A, 0x1C, 0x1E),
                                  in2);
  ret.im = _mm512_permutex2var_ps(in1,
                                  _mm512_setr_epi32(0x01, 0x03, 0x05, 0x07,
                                                    0x09, 0x0B, 0x0D, 0x0F,
                                                    0x11, 0x13, 0x15, 0x17,
                                                    0x19, 0x1B, 0x1D, 0x1F),
                                  in2);
...
//------------------------------------------------------------------------------
/* Complex Single precission Floating point functions */
static inline SimdCf_t LteSimdCfiLoadu(const Cf_t *ptr)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
  __m512 in1 = _mm512_loadu_ps((float*)(ptr));
  __m512 in2 = _mm512_loadu_ps((float*)(ptr + LTE_SIMD_CF_SIZE / 2));
  ret.re = _mm512_permutex2var_ps(in1,
                                  _mm512_setr_epi32(0x00, 0x02, 0x04, 0x06,
                                                    0x08, 0x0A, 0x0C, 0x0E,
                                                    0x10, 0x12, 0x14, 0x16,
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfLoad(const float *re, const float *im)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfLoadu(const float *re, const float *im)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline void LteSimdCfiStore(Cf_t *ptr, SimdCf_t simdreg)
  {
#ifdef LV_HAVE_AVX512
  __m512 s1 = _mm512_permutex2var_ps(simdreg.re,
                                     _mm512_setr_epi32(0x00, 0x10, 0x01, 0x11,
                                                       0x02, 0x12, 0x03, 0x13,
                                                       0x04, 0x14, 0x05, 0x15,
                                                       0x06, 0x16, 0x07, 0x17),
                                     simdreg.im);
  __m512 s2 = _mm512_permutex2var_ps(simdreg.re,
                                     _mm512_setr_epi32(0x08, 0x18, 0x09, 0x19,
                                                       0x0A, 0x1A, 0x0B, 0x1B,
                                                       0x0C, 0x1C, 0x0D, 0x1D,
                                                       0x0E, 0x1E, 0x0F, 0x1F),
                                     simdreg.im);
...
//------------------------------------------------------------------------------
static inline void LteSimdCfiStoreu(Cf_t *ptr, SimdCf_t simdreg)
  {
#ifdef LV_HAVE_AVX512
  __m512 s1 = _mm512_permutex2var_ps(simdreg.re,
                                     _mm512_setr_epi32(0x00, 0x10, 0x01, 0x11,
...
//------------------------------------------------------------------------------
static inline void LteSimdCfStore(float *re, float *im, SimdCf_t simdreg)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline void LteSimdCfStoreu(float *re, float *im, SimdCf_t simdreg)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdF_t LteSimdCfRe(SimdCf_t in)
  {
#ifdef HAVE_NEON
  SimdF_t out = in.val[0];
#else
  SimdF_t out = in.re;
#endif /*HAVE_NEON*/
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfSet1(Cf_t x)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfProd (SimdCf_t a, SimdCf_t b)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfConjprod (SimdCf_t a, SimdCf_t b)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfAdd (SimdCf_t a, SimdCf_t b)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfSub (SimdCf_t a, SimdCf_t b)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfMul (SimdCf_t a, SimdF_t b)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfRcp (SimdCf_t a)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
  SimdF_t a2re = _mm512_mul_ps(a.re, a.re);
  SimdF_t a2im = _mm512_mul_ps(a.im, a.im);
  SimdF_t mod2 = _mm512_add_ps(a2re, a2im);
  SimdF_t rcp = _mm512_rcp14_ps(mod2);
  SimdF_t neg_a_im = _mm512_xor_ps(_mm512_set1_ps(-0.0f), a.im);
  ret.re = _mm512_mul_ps(a.re, rcp);
  ret.im = _mm512_mul_ps(neg_a_im, rcp);
#else /* LV_HAVE_AVX512 */
#ifdef LV_HAVE_AVX2
  SimdF_t a2re = _mm256_mul_ps(a.re, a.re);
  SimdF_t a2im = _mm256_mul_ps(a.im, a.im);
  SimdF_t mod2 = _mm256_add_ps(a2re, a2im);
  SimdF_t rcp = _mm256_rcp_ps(mod2);
  SimdF_t neg_a_im = _mm256_xor_ps(_mm256_set1_ps(-0.0f), a.im);
  ret.re = _mm256_mul_ps(a.re, rcp);
  ret.im = _mm256_mul_ps(neg_a_im, rcp);
#else /* LV_HAVE_AVX2 */
#ifdef LV_HAVE_SSE
  SimdF_t a2re = _mm_mul_ps(a.re, a.re);
  SimdF_t a2im = _mm_mul_ps(a.im, a.im);
  SimdF_t mod2 = _mm_add_ps(a2re, a2im);
  SimdF_t rcp = _mm_rcp_ps(mod2);
  SimdF_t neg_a_im = _mm_xor_ps(_mm_set1_ps(-0.0f), a.im);
  ret.re = _mm_mul_ps(a.re, rcp);
  ret.im = _mm_mul_ps(neg_a_im, rcp);
#else /* LV_HAVE_SSE */
#ifdef HAVE_NEON
  SimdF_t a2re = vmulq_f32(a.val[0], a.val[0]);
  SimdF_t a2im = vmulq_f32(a.val[1], a.val[1]);
  SimdF_t mod2 = vaddq_f32(a2re, a2im);
  SimdF_t rcp = vmulq_f32(vrecpeq_f32(mod2),
                          vrecpsq_f32(vrecpeq_f32(mod2),
                                      mod2));
  SimdF_t neg_a_im = vnegq_f32(a.val[1]);
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfNeg (SimdCf_t a)
  {
  SimdCf_t ret;
#if HAVE_NEON
  ret.val[0] = LteSimdFNeg(a.val[0]);
  ret.val[1] = LteSimdFNeg(a.val[1]);
#else  /* HAVE_NEON */
  ret.re = LteSimdFNeg(a.re);
  ret.im = LteSimdFNeg(a.im);
#endif /* HAVE_NEON */
  return ret;
  }

//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfNegMask (SimdCf_t a, SimdF_t mask)
  {
  SimdCf_t ret;
#ifndef LV_HAVE_AVX512
#ifdef LV_HAVE_AVX2
...
#endif /* LV_HAVE_AVX512 */
#if HAVE_NEON
  ret.val[0] = LteSimdFNegMask(a.val[0], mask);
  ret.val[1] = LteSimdFNegMask(a.val[1], mask);
#else /* HAVE_NEON */
  ret.re = LteSimdFNegMask(a.re, mask);
  ret.im = LteSimdFNegMask(a.im, mask);
#endif /* HAVE_NEON */
  return ret;
  }

//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfConj (SimdCf_t a)
  {
  SimdCf_t ret;
#if HAVE_NEON
  ret.val[0] = a.val[0];
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfMulj (SimdCf_t a)
  {
  SimdCf_t ret;
#if HAVE_NEON
  ret.val[0] = LteSimdFNeg(a.val[1]);
  ret.val[1] = a.val[0];
#else /* HAVE_NEON */
  ret.re = LteSimdFNeg(a.im);
  ret.im = a.re;
#endif /* HAVE_NEON */
  return ret;
  }
...
//------------------------------------------------------------------------------
static inline SimdCf_t LteSimdCfZero (void)
  {
  SimdCf_t ret;
#ifdef LV_HAVE_AVX512
...
#ifdef LV_HAVE_AVX512
typedef __m512i SimdI_t;
typedef __mmask16 SimdSel_t;
#else /* LV_HAVE_AVX512 */
#ifdef LV_HAVE_AVX2
typedef __m256i SimdI_t;
typedef __m256 SimdSel_t;
#else /* LV_HAVE_AVX2 */
#ifdef LV_HAVE_SSE
typedef __m128i SimdI_t;
typedef __m128 SimdSel_t;
#else /* LV_HAVE_AVX2 */
#ifdef HAVE_NEON
typedef int32x4_t SimdI_t;
typedef int32x4_t SimdSel_t;
#endif /* HAVE_NEON */
#endif /* LV_HAVE_SSE */
#endif /* LV_HAVE_AVX2 */
#endif /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline SimdI_t LteSimdILoad(int *x)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline void LteSimdIStore(int *x, SimdI_t reg)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdI_t LteSimdISet1(int x)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdI_t LteSimdIAdd(SimdI_t a, SimdI_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdSel_t LteSimdFMax(SimdF_t a, SimdF_t b)
  {
#ifdef LV_HAVE_AVX512
...
#else /* LV_HAVE_AVX2 */
#ifdef LV_HAVE_SSE
  return  (SimdSel_t) _mm_cmpgt_ps(a, b);
#else /* LV_HAVE_SSE */
#ifdef HAVE_NEON
  return  (SimdSel_t) vcgtq_f32(a, b);
#endif /* HAVE_NEON */
#endif /* LV_HAVE_SSE */
#endif /* LV_HAVE_AVX2 */
#endif /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline SimdI_t LteSimdISelect(SimdI_t a, SimdI_t b, SimdSel_t selector)
  {
#ifdef LV_HAVE_AVX512
...
#ifdef LV_HAVE_AVX512
typedef __m512i SimdS_t;
#else /* LV_HAVE_AVX512 */
#ifdef LV_HAVE_AVX2
typedef __m256i SimdS_t;
#else /* LV_HAVE_AVX2 */
#ifdef LV_HAVE_SSE
typedef __m128i SimdS_t;
#else /* LV_HAVE_SSE */
#ifdef HAVE_NEON
typedef int16x8_t SimdS_t;
#endif /* HAVE_NEON */
#endif /* LV_HAVE_SSE */
#endif /* LV_HAVE_AVX2 */
#endif /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline SimdS_t LteSimdSLoad(const int16_t *ptr)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdS_t LteSimdSLoadu(const int16_t *ptr)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline void LteSimdSStore(int16_t *ptr, SimdS_t simdreg)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline void LteSimdSStoreu(int16_t *ptr, SimdS_t simdreg)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdS_t LteSimdSZero(void)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdS_t LteSimdSMul(SimdS_t a, SimdS_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdS_t LteSimdSNeg(SimdS_t a, SimdS_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdS_t LteSimdSAdd(SimdS_t a, SimdS_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdS_t LteSimdSSub(SimdS_t a, SimdS_t b)
  {
#ifdef LV_HAVE_AVX512
...
static inline SimdC16_t LteSimdC16iLoad(const C16_t *ptr)
  {
  SimdC16_t ret;
#ifdef LV_HAVE_AVX512
  __m512i in1 = _mm512_load_si512((__m512i*)(ptr));
  __m512i in2 = _mm512_load_si512((__m512i*)(ptr + 8));
  ret.re.m512 = _mm512_mask_blend_epi16(0xAAAAAAAA,
                                        in1,
                                        _mm512_shufflelo_epi16(_mm512_shufflehi_epi16(in2,
      0b10100000),
                                                               0b10100000));
  ret.im.m512 = _mm512_mask_blend_epi16(0xAAAAAAAA,
                                        _mm512_shufflelo_epi16(_mm512_shufflehi_epi16(in1,
      0b11110101),
                                                               0b11110101),
                                         in2);
#else /* LV_HAVE_AVX2 */
  ...
  ret.re.m256 = _mm256_blend_epi16(in1,
                                   _mm256_shufflelo_epi16(_mm256_shufflehi_epi16(in2,
 0b10100000),
                                                          0b10100000),
                                   0b10101010);
  ret.im.m256 = _mm256_blend_epi16(_mm256_shufflelo_epi16(_mm256_shufflehi_epi16(in1,
 0b11110101),
                                                          0b11110101),
                                   in2,
                                   0b10101010);
  ...
  ret.re.m128 = _mm_blend_epi16(in1,
                                _mm_shufflelo_epi16(_mm_shufflehi_epi16(in2,
                                                                        0b10100000),
                                                    0b10100000), 
                                0b10101010);
  ret.im.m128 = _mm_blend_epi16(_mm_shufflelo_epi16(_mm_shufflehi_epi16(in1,
                                                                        0b11110101),
                                                    0b11110101),
                                in2,
                                0b10101010);
...
//------------------------------------------------------------------------------
static inline SimdC16_t LteSimdC16Load(const int16_t *re, const int16_t *im)
  {
  SimdC16_t ret;
#ifdef LV_HAVE_AVX2
...
//------------------------------------------------------------------------------
static inline SimdC16_t LteSimdC16Loadu(const int16_t *re, const int16_t *im)
  {
  SimdC16_t ret;
#ifdef LV_HAVE_AVX2
...
//------------------------------------------------------------------------------
static inline void LteSimdC16iStore(C16_t *ptr, SimdC16_t simdreg)
  {
#ifdef LV_HAVE_AVX2
  __m256i re_sw = _mm256_shufflelo_epi16(_mm256_shufflehi_epi16(simdreg.re.m256,
                                                                0b10110001),
                                         0b10110001);
  __m256i im_sw = _mm256_shufflelo_epi16(_mm256_shufflehi_epi16(simdreg.im.m256,
                                                                0b10110001),
                                         0b10110001);
  _mm256_store_si256((__m256i *) (ptr),
                     _mm256_blend_epi16(simdreg.re.m256, im_sw, 0b10101010));
  _mm256_store_si256((__m256i *) (ptr + 8),
                     _mm256_blend_epi16(re_sw, simdreg.im.m256, 0b10101010));
#else
#ifdef LV_HAVE_SSE
  __m128i re_sw = _mm_shufflelo_epi16(_mm_shufflehi_epi16(simdreg.re.m128,
                                                          0b10110001),
                                      0b10110001);
  __m128i im_sw = _mm_shufflelo_epi16(_mm_shufflehi_epi16(simdreg.im.m128,
                                                          0b10110001),
                                      0b10110001);
  _mm_store_si128((__m128i *) (ptr),
                  _mm_blend_epi16(simdreg.re.m128, im_sw, 0b10101010));
  _mm_store_si128((__m128i *) (ptr + 8),
                  _mm_blend_epi16(re_sw, simdreg.im.m128, 0b10101010));
#else /*HAVE_NEON*/
#ifdef HAVE_NEON
...
//------------------------------------------------------------------------------
static inline void LteSimdC16iStoreu(C16_t *ptr, SimdC16_t simdreg)
  {
#ifdef LV_HAVE_AVX2
  __m256i re_sw = _mm256_shufflelo_epi16(_mm256_shufflehi_epi16(simdreg.re.m256,
                                                                0b10110001),
  ...
  _mm256_storeu_si256((__m256i *) (ptr),
                      _mm256_blend_epi16(simdreg.re.m256,
                                         im_sw,
                                         0b10101010));
  _mm256_storeu_si256((__m256i *) (ptr + 8),
                      _mm256_blend_epi16(re_sw,
                                         simdreg.im.m256,
                                         0b10101010));
#else
#ifdef LV_HAVE_SSE
  ...
  _mm_storeu_si128((__m128i *) (ptr),
                    _mm_blend_epi16(simdreg.re.m128,
                                    im_sw,
                                    0b10101010));
  _mm_storeu_si128((__m128i *) (ptr + 8),
                    _mm_blend_epi16(re_sw,
                                    simdreg.im.m128,
                                    0b10101010));
#else /*HAVE_NEON*/
#ifdef HAVE_NEON
...
//------------------------------------------------------------------------------
static inline void LteSimdC16Store(int16_t *re, int16_t *im, SimdC16_t simdreg)
  {
#ifdef LV_HAVE_AVX2
...
//------------------------------------------------------------------------------
static inline void LteSimdC16Storeu(int16_t *re, int16_t *im, SimdC16_t simdreg)
  {
#ifdef LV_HAVE_AVX2
...
//------------------------------------------------------------------------------
static inline SimdC16_t LteSimdC16Prod (SimdC16_t a, SimdC16_t b)
  {
  SimdC16_t ret;
#ifdef LV_HAVE_AVX2
...
//------------------------------------------------------------------------------
static inline SimdC16_t LteSimdC16Add (SimdC16_t a, SimdC16_t b)
  {
  SimdC16_t ret;
#ifdef LV_HAVE_AVX2
...
//------------------------------------------------------------------------------
static inline SimdC16_t LteSimdC16Zero (void)
  {
  SimdC16_t ret;
#ifdef LV_HAVE_AVX2
...
#endif /* LTE_SIMD_C16_SIZE */

#if LTE_SIMD_F_SIZE && LTE_SIMD_S_SIZE

//------------------------------------------------------------------------------
static inline SimdS_t LteSimdConvert2fS(SimdF_t a, SimdF_t b)
  {
#ifdef LV_HAVE_AVX512
  __m512 aa = _mm512_permutex2var_ps(a,
                                     _mm512_setr_epi32(0x00, 0x01, 0x02, 0x03,
                                                       0x08, 0x09, 0x0A, 0x0B,
                                                       0x10, 0x11, 0x12, 0x13,
                                                       0x18, 0x19, 0x1A, 0x1B),
                                     b);
  __m512 bb = _mm512_permutex2var_ps(a,
                                     _mm512_setr_epi32(0x04, 0x05, 0x06, 0x07,
                                                       0x0C, 0x0D, 0x0E, 0x0F,
                                                       0x14, 0x15, 0x16, 0x17,
                                                       0x1C, 0x1D, 0x1E, 0x1F),
                                     b);
  ...
  return (SimdS_t)vcombine_s16(vqmovn_s32(ai), vqmovn_s32(bi));
#endif /* HAVE_NEON */
#endif /* LV_HAVE_SSE */
#endif /* LV_HAVE_AVX2 */
#endif /* LV_HAVE_AVX512 */
...
#endif /* LTE_SIMD_F_SIZE && LTE_SIMD_C16_SIZE */

#if LTE_SIMD_B_SIZE
/* Data types */
#ifdef LV_HAVE_AVX512
typedef __m512i SimdB_t;
#else /* LV_HAVE_AVX512 */
#ifdef LV_HAVE_AVX2
typedef __m256i SimdB_t;
#else /* LV_HAVE_AVX2 */
#ifdef LV_HAVE_SSE
typedef __m128i SimdB_t;
#else /* HAVE_NEON */
#ifdef HAVE_NEON
typedef int8x16_t SimdB_t;
#endif /* HAVE_NEON */
#endif /* LV_HAVE_SSE */
#endif /* LV_HAVE_AVX2 */
#endif /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline SimdB_t LteSimdBLoad(const int8_t *ptr)
  {
#ifdef LV_HAVE_AVX512
  return _mm512_load_si512(ptr);
#else /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline SimdB_t LteSimdBLoadu(const int8_t *ptr)
  {
#ifdef LV_HAVE_AVX512
  return _mm512_loadu_si512(ptr);
#else /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline void LteSimdBStore(int8_t *ptr, SimdB_t simdreg)
  {
#ifdef LV_HAVE_AVX512
  _mm512_store_si512(ptr, simdreg);
#else /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline void LteSimdBStoreu(int8_t *ptr, SimdB_t simdreg)
  {
#ifdef LV_HAVE_AVX512
  _mm512_storeu_si512(ptr, simdreg);
#else /* LV_HAVE_AVX512 */
...
//------------------------------------------------------------------------------
static inline SimdB_t LteSimdBXor(SimdB_t a, SimdB_t b)
  {
...
//------------------------------------------------------------------------------
static inline SimdB_t LteSimdBSub(SimdB_t a, SimdB_t b)
  {
#ifdef LV_HAVE_AVX512
...
//------------------------------------------------------------------------------
static inline SimdS_t LteSimdBNeg(SimdB_t a, SimdB_t b)
  {
#ifdef LV_HAVE_AVX512
  __m256i a0 = _mm512_extracti64x4_epi64(a, 0);
  __m256i a1 = _mm512_extracti64x4_epi64(a, 1);
