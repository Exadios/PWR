...
# Generated: Tue Jun 25 20:03:12 2019
##################################################
...
class example_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "example_1")
...
def main(top_block_cls=example_1, options=None):
